...
public class UserDAO {
	...
	public void updateUser(User user) throws SQLException {
		...
		StringBuilder sql = new StringBuilder("UPDATE user SET ");  // SET 뒤에 문자열 공백값은 반드시 지정한다
		...
		PreparedStatement statement = connnection.prepareStatement(sql.toString());
